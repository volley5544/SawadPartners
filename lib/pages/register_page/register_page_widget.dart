...
class _RegisterPageWidgetState extends State<RegisterPageWidget>
  ...
  void initState() {
    ...
    _model.thaiIDTextController ??= TextEditingController();
    _model.thaiIDFocusNode ??= FocusNode();

    _model.thaiIDMask = MaskTextInputFormatter(mask: '#-####-#####-##-#');
                            ...
                            child: Padding(
                              ...
                              child: TextFormField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  hintText: 'กรุณาใส่ ชื่อ-นามสกุล',
                                  hintStyle: FlutterFlowTheme.of(context)
                                      .bodySmall
                                      .override(
                                        fontFamily: FlutterFlowTheme.of(context)
                          ...
                          Form(
                            ...
                            child: Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  16.0, 20.0, 16.0, 0.0),
                              child: TextFormField(
                                controller: _model.thaiIDTextController,
                                focusNode: _model.thaiIDFocusNode,
                                autofocus: false,
                                obscureText: false,
                                decoration: InputDecoration(
                                  labelText: 'Thai ID',
                                ...
                                validator: _model.thaiIDTextControllerValidator
                                    .asValidator(context),
                                inputFormatters: [_model.thaiIDMask],
                              ).animateOnPageLoad(animationsMap[
                            ...
                            child: Padding(
                              ...
                              child: TextFormField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  hintText: 'กรุณาใส่ เบอร์โทรศัพท์',
                                  hintStyle: FlutterFlowTheme.of(context)
                                      .bodySmall
                                      .override(
                                        fontFamily: FlutterFlowTheme.of(context)
                          ...
                          Padding(
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                ...
                                if (!(((/* NOT RECOMMENDED */ _model.emailTextController.text == 'true') &&
                                ...
                                _model.thaiIDOutput = await actions.checkThaiID(
                                  _model.thaiIDTextController.text,
                                );
                                _shouldSetState = true;
                                if (!_model.thaiIDOutput!) {
                                  await showDialog(
                                    context: context,
                                    builder: (alertDialogContext) {
                                      return WebViewAware(
                                        child: AlertDialog(
                                          content: Text(
                                              'กรุณาใส่เลขบัตรประชาชนให้ถูกต้อง'),
                                          actions: [
                                            TextButton(
                                              onPressed: () => Navigator.pop(
                                                  alertDialogContext),
                                ...
                                _model.createFirebaseOutput =
                                    await actions.createFirebaseCopy(
                                  ...
                                  await showDialog(
                                    ...
                                    builder: (alertDialogContext) {
                                      return WebViewAware(
                                        child: AlertDialog(
                                          content: Text(
                                              'username ถูกใช้แล้วกรุณาลองใหม่'),
                                          actions: [
                                            TextButton(
                                              onPressed: () => Navigator.pop(
                                                  alertDialogContext),
