                                    ...
                                    child: Container(
                                      ...
                                      child: CachedNetworkImage(
                                        ...
                                        fadeOutDuration:
                                            Duration(milliseconds: 500),
                                        imageUrl: _model
                                            .uploadedFileUrl_uploadMedia7d2,
                                        fit: BoxFit.cover,
                                      ),
                                    ),
                                  ),
                            ...
                            FFButtonWidget(
                              onPressed: () async {
                                ...
                                if (selectedMedia != null &&
                                  ...
                                  safeSetState(() => _model
                                      .isDataUploading_uploadMedia7d2 = true);
                                  ...
                                  try {
                                    ...
                                    ScaffoldMessenger.of(context)
                                        .hideCurrentSnackBar();
                                    _model.isDataUploading_uploadMedia7d2 =
                                        false;
                                  }
                                  if (selectedUploadedFiles.length ==
                                      ...
                                      downloadUrls.length ==
                                          selectedMedia.length) {
                                    safeSetState(() {
                                      _model.uploadedLocalFile_uploadMedia7d2 =
                                          selectedUploadedFiles.first;
                                      _model.uploadedFileUrl_uploadMedia7d2 =
                                          downloadUrls.first;
                                    });
