...
import 'customer_pending_model.dart';
export 'customer_pending_model.dart';

class CustomerPendingWidget extends StatefulWidget {
  const CustomerPendingWidget({super.key});

  static String routeName = 'customerPending';
  static String routePath = 'customerPending';

  @override
  State<CustomerPendingWidget> createState() => _CustomerPendingWidgetState();
}

class _CustomerPendingWidgetState extends State<CustomerPendingWidget>
    with TickerProviderStateMixin {
  late CustomerPendingModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CustomerPendingModel());
